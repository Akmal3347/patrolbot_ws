...
#include "robot_hardware/diffbot_system.hpp"
...
hardware_interface::return_type robot_hardware::DiffDriveArduinoHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_.connected())
  {
...
PLUGINLIB_EXPORT_CLASS(
  robot_hardware::DiffDriveArduinoHardware, hardware_interface::SystemInterface)
